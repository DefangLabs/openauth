...
export declare const FabricController: {
  ...
  readonly methods: {
    ...
    readonly putSecret: {
      ...
      readonly I: typeof PutConfigRequest,
      readonly O: typeof Empty,
      readonly kind: MethodKind.Unary,
    },
    /**
     ...
     */
    readonly getConfigs: {
      readonly name: "GetConfigs",
      readonly I: typeof GetConfigsRequest,
      readonly O: typeof GetConfigsResponse,
      readonly kind: MethodKind.Unary,
      readonly idempotency: MethodIdempotency.NoSideEffects,
    },
    /**
     ...
     */
    readonly deleteConfigs: {
      readonly name: "DeleteConfigs",
    ...
    readonly preview: {
      ...
      readonly I: typeof PreviewRequest,
