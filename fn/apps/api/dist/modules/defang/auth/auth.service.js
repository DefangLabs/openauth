...
var get_jwt_from_request_1 = require("../../../lib/auth/get-jwt-from-request");
...
var getDefangToken = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var heimdallJWT, client, tokenRequest, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, get_jwt_from_request_1.getJwtFromRequest)(req)];
            case 1:
                heimdallJWT = _a.sent();
                if (!heimdallJWT) {
                    return [2 /*return*/, res.status(401).json({ error: 'Unauthorized' })];
                }
                client = (0, get_client_1.getClient)();
                tokenRequest = (0, protobuf_1.create)(fabric_pb_1.TokenRequestSchema, {
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, client.token(tokenRequest)];
            case 3:
                response = _a.sent();
                return [2 /*return*/, res.status(201).json({ token: response === null || response === void 0 ? void 0 : response.accessToken })];
            case 4:
                e_1 = _a.sent();
                console.log('@@ err: ', e_1);
