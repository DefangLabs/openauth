...
exports.getServiceLogs = exports.getService = exports.getServices = void 0;
...
var getDefangToken = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                token = _a.sent();
                _a.label = 4;
            case 4: return [2 /*return*/, token ? token : process.env["DEFANG_TOKEN"]];
        }
    });
}); };
var getClient = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultFabric, defangToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                defaultFabric = process.env["DEFANG_FABRIC"] || "fabric-prod1.defang.dev:443";
                return [4 /*yield*/, getDefangToken(req)];
            case 1:
                defangToken = _a.sent();
                return [2 /*return*/, new fabric.FabricControllerClient(defaultFabric, grpc.credentials.combineChannelCredentials(grpc.credentials.createSsl(), grpc.credentials.createFromMetadataGenerator(function (_, callback) {
                        var metadata = new grpc.Metadata();
...
function getServices(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getClient(req)];
                case 1:
                    client = _a.sent();
                    client.getServices(new google_protobuf_empty_pb.Empty, function (err, response) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getClient(req)];
                case 1:
                    client = _a.sent();
                    client.getServices(new google_protobuf_empty_pb.Empty, function (err, response) {
                        var service = response === null || response === void 0 ? void 0 : response.toObject().servicesList.find(function (service) { var _a; return ((_a = service.service) === null || _a === void 0 ? void 0 : _a.name) === name; });
                        if (service) {
                            res.send(service);
                        }
                        else {
...
var getServiceLogs = function (ws, req) { return __awaiter(void 0, void 0, void 0, function () {
    var name, serviceId;
    return __generator(this, function (_a) {
        console.log('@@ test');
        name = req.params.serviceName;
        serviceId = new fabric_pb_1.ServiceID();
